                ...
                <div className="glass-card" style={{ minHeight: '400px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: '3rem' }}>
                        ...
                        <div style={{ width: '100%' }}>
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '2rem' }}>
                                {premiumItems.map(item => (
                                    <div key={item.name} className="glass-card" style={{ background: 'rgba(255,255,255,0.03)' }}>
                    ...
                    {activeTab === 'buy' && (
                        <div style={{ width: '100%' }}>
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '2rem' }}>
                                {coinPacks.map(pack => (
                                    <div key={pack.amount} className="glass-card" style={{ background: 'rgba(255,255,255,0.03)' }}>
